...
type Section = "words" | "grammar" | Skill;
...
export function CurriculumLesson({ stageId }: { stageId: string }) {
  ...
  function changeSection(next: Section) { setSection(next); setFeedback(null); setError(""); }
