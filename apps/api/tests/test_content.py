...
@pytest.mark.parametrize(
    ...
    [
        ...
        (lambda d: d["steps"][0].__setitem__("skill", "listening"), "does not match payload"),
        ...
        (lambda d: d["scenarios"][0]["available_slots"][0].__setitem__("day", "2020-01-01"),
         "before the scenario reference date"),
